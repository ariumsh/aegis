      ...
      ContainerComponent([
        SectionComponent(
          ...
          ],
          {
            ...
            custom_id: "duration",
            label: durationLabel,
            emoji: { id: Emojis.date_emoji.match(/\d+/)?.[0] ?? undefined },
          },
        ),
        ...(reason
          ? [
    ...
    components: [
      ContainerComponent([
        SectionComponent([TextDisplayComponent(`## ${data.title}⠀⠀⠀⠀⠀`)], {
          ...
          emoji: { id: Emojis.configuration_emoji.match(/\d+/)?.[0] ?? undefined },
        }),
        ...
        [
          SectionComponent(
            [TextDisplayComponent(`## ${data.title}\n\n${data.description}`)],
            {
              ...
              emoji: { id: Emojis.disabled_module_emoji.match(/\d+/)?.[0] ?? undefined },
            },
          ),
          SeparatorComponent(),
          TextDisplayComponent(
    ...
    components: [
      ContainerComponent([
        SectionComponent([TextDisplayComponent(`## ${data.labels.title}`)], {
          ...
          emoji: { id: Emojis.static_setting_emoji.match(/\d+/)?.[0] ?? undefined },
        }),
        SeparatorComponent(),
